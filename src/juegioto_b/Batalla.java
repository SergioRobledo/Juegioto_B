                            ...
                            case 1:    
                                {
                                    ...
                                    if (res == c){
                                        ...
                                        System.out.println( Personaje.player2.getNombre() + " ::¡CERTERO!\n DAÑO DE ATAQUE :: " + Personaje.player2.getAtq1() + " ptos. A " + Personaje.player1.getNombre() + " LE QUEDAN [" + Personaje.player1.getVida() + "] PUNTOS DE VIDA \n");
                                        turno=1;
                                    }else    
                            ...
                            case 1:   
                                {
                                    ...
                                    if (res == c){
                                        ...
                                        System.out.println( Personaje.player2.getNombre() + " ::¡SORPRESA!\n DAÑO DE ATAQUE :: " + Personaje.player2.getAtq2() + " ptos. A " + Personaje.player1.getNombre() + " LE QUEDAN [" + Personaje.player1.getVida() + "] PUNTOS DE VIDA \n");					turno=1;
                                    }else    
                                        System.out.println("Respuesta incorrecta. Ataque fallido");
                                    System.out.println(Personaje.player2.getNombre() + " :: Tiene :: " + Personaje.player2.getVida() + " :: vida");
                                    turno=1;
                            ...
                            case 1:    
                                {
                                    ...
                                    if (res == c){
                                        ...
                                        System.out.println( Personaje.player2.getNombre() + " ::ESO VA A DOLER MAÑANA...!\n DAÑO DE ATAQUE :: " + Personaje.player2.getAtq3() + " ptos. A " + Personaje.player1.getNombre() + " LE QUEDAN [" + Personaje.player1.getVida() + "] PUNTOS DE VIDA \n");					turno=1;
                                    }else    
                                        System.out.println("Respuesta incorrecta. Ataque fallido");
                                    System.out.println(Personaje.player2.getNombre() + " :: Tiene :: " + Personaje.player2.getVida() + " :: vida");
                                    turno=1;
                            ...
                            case 1:
                                {
                                    ...
                                    if (res == c){
                                        ...
                                        System.out.println( Personaje.player1.getNombre() + " ::¡MUY BIEN!\n DAÑO DE ATAQUE :: " + Personaje.player1.getAtq1() + " ptos. A " + Personaje.player2.getNombre() + " LE QUEDAN [" + Personaje.player2.getVida() + "] PUNTOS DE VIDA \n");					turno=0;
                                    }else    
                                        System.out.println("Respuesta incorrecta. Ataque fallido");
                            ...
                            case 1:    
                                {
                                    ...
                                    if (res == c){
                                        ...
                                        System.out.println( Personaje.player1.getNombre() + " ::¡CERTERO!\n DAÑO DE ATAQUE :: " + Personaje.player1.getAtq2() + " ptos. A " + Personaje.player2.getNombre() + " LE QUEDAN [" + Personaje.player2.getVida() + "] PUNTOS DE VIDA \n");					turno=0;
                                    }else    
                                        System.out.println("Respuesta incorrecta. Ataque fallido");
                                    System.out.println(Personaje.player1.getNombre() + " :: Tiene :: " + Personaje.player1.getVida() + " :: vida");
                                    turno=0;
                            ...
                            case 1:    
                                {
                                    ...
                                    if (res == c){
                                        ...
                                        System.out.println( Personaje.player1.getNombre() + " ::¡GOLPE CRÍTICO!\n DAÑO DE ATAQUE :: " + Personaje.player1.getAtq3() + " ptos. A " + Personaje.player2.getNombre() + " LE QUEDAN [" + Personaje.player2.getVida() + "] PUNTOS DE VIDA \n");					turno=0;
